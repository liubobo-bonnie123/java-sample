...
public class UnibergSearchTitle extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		web.loadUrl("http://x-search.jp/us/article?media=1&type=2/q=kapil");
		setContentView(R.layout.search_titles_screen);
	 ...
	 */
	private void done() {
		UnibergSearchTitle.this.finish();
	}
